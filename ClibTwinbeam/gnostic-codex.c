...
int charcoals(const char * utf8format, ...)
{
   ...
   va_epilogue
   print("\xe2\xbf\xab"); /* U+2FEB */
   return y;
}

/* and v-space 2cm */
/* "vspace 7.0 cm; draw (100.0, 100.0)--(150.0, 150.0)--(200.0, 200.0)--(174.0, 175.0)--cycle; " straight lines, ---
"draw (100.0, 100.0)..(150.0, 150.0)..(200.0, 200.0)..(174.0, 175.0)..cycle"); curves, ... */
