...
/* clang -o x86_confidence -DSHA1GIT=\"`git log -1 '--pretty=format:%h'`\"     \
    ...
    o-binary.o partial-referen.o queue-invent.o recoll-transmit.o              \
...
/* clang -c -DSHA1GIT=\"`git log -1 '--pretty=format:%h'`\"                    \
    ...
    o-binary.c partial-referen.c lock-arrange.c queue-invent.c                 \
    recoll-transmit.c round-fixed.c search-seek.c semantic-symbol.c            \
    thread-fork.c tiles-map.c */
...
/* clang -o arm_confidence -DSHA1GIT=\"`git log -1 '--pretty=format:%h'`\" -D__armv8a__ \
    ...
    amend-augment.o arabic-edit.o avant-garde.o float-short.o o-binary.o       \
    partial-referen.o queue-invent.o recoll-transmit.o  round-fixed.o          \
...
/* clang -c -DSHA1GIT=\"`git log -1 '--pretty=format:%h'`\" -D__armv8a__       \
    ...
    amend-augment.c arabic-edit.c avant-garde.c float-short.c lock-arrange.c   \
    o-binary.c partial-referen.c queue-invent.c recoll-transmit.c              \
